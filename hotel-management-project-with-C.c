...
void Food_order(int r) {
	...
	char Food[50][25] = {"SHAHI PANEER", "KADAI PANEER", "CHEESE KORMA", "MALAI KOFTA ", "MATAR PANEER",
	                     ...
	                     "MUSHROOM PANEER", "MASALA DOSA", "MASALA CHICKEN", "DAHI VADA", "MUTTON KORMA", "MUTTON CURRY",
	                     "EGG CURRY", "BUTTER CHICKEN", "FISH CURRY", "CHICKEN CURRY", "CHILLI CHICKEN", "CHICKEN TIKKA",
	                     "SEEKH KABAB", "CHICKEN TANDORI", "PANEER TIKKA", "CHICKEN SEEKHKABAB", "CHICKEN BIRYANI", "PANEER PULAO",
...
void Room_Features() {
	...
	if (r <= 20) {
		...
		printf("\n Price per night: 3000/- (Including Breakfast)");
		printf("\n\n Additional Features :");
		printf("\n -> Television & MP3 dock");
		...
		printf("\n A.C./Non A.C.: A.C. Type");
		printf("\n Price per night: 2000/- (Including Breakfast)");
		printf("\n\n Additional Features :");
		printf("\n ->Television");
		printf("\n ->Free Wi-Fi");
		printf("\n ->Refrigerator");
		...
		printf("\n A.C./Non A.C.: A.C. Type");
		printf("\n Price per night: 2700/- (Including Breakfast)");
		printf("\n\n Additional Features :");
		printf("\n ->Free Wi-Fi");
		printf("\n ->Geyser");
	} else if (r > 55 && r <= 75) {
		...
		printf("\n A.C./Non A.C.: A.C. Type");
		printf("\n Price per night: 3600/- (Including Breakfast)");
		printf("\n Additional Features :");
		printf("\n ->Television");
		printf("\n ->Free Wi-Fi");
		printf("\n ->Refrigerator");
		...
		printf("\n Price per night: 1000/- (Including Breakfast)");
	} else if (r > 90 && r <= 100) {
